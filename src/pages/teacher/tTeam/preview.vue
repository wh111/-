                            ...
                            <template v-for="(cItem,index) in info.questionsList[questionsTypeId]">
                                <question-show :key="cItem.id" :index="index+1"
                                    ...
                                    <template slot="todoBox">
                                        ...
                                        <x-button mini type="success" style="height: 0.22rem;line-height: 0.22rem"
                                        ...
                                        <select   v-model="todoType[cItem.id]" placeholder="管理试题" style="width: 0.6rem;border-radius: 0.03rem;font-size: 0.1rem"
                                                @change="changeTodoType(todoType[cItem.id])">
                                            <option label="管理试题" value="undefined" style="display: none"  disabled selected>管理试题</option>
