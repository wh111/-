    ...
    <div class="questionBox">
        <div class="questionBox">
            ...
            <div class="qContent" style="width: 3.75rem">
                ...
                <!-- 问题选项 -->
                <div class="qcMain">
                    <div v-if="!isPublicSelact" class="qcmSel" :class="answerVal === index&&showInput?'active-border':''"  @click="choice(index)" v-for="(str,index) in questionData.questionsOptions"
                            :key="index">

                        <div v-if="showInput" class="qcmSelItem"  :class="answerVal === index?'active':''" @click.native="choice(index)">{{ index | getCharCode }}</div>
