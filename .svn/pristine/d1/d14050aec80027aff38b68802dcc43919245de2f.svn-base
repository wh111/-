    ...
    <div>
        <div class="questionBox">
            ...
            <div class="qContent">
                ...
                <!-- 问题选项 -->
                <div class="qcMain">
                    <div v-if="!isPublicSelact" :class="!!~answerVal.indexOf(index)&&showInput?'active-border':''"  @click="choice(index)"  class="qcmSel" v-for="(str,index) in questionData.questionsOptions"
                         :key="index">
                        <span v-if="showInput" :class="!!~answerVal.indexOf(index)?'active':''"class="qcmSelItem">{{ index | getCharCode }}</span>
                        <span v-else   class="qcmSelItem">{{ index | getCharCode }}</span>
                ...
                <div class="qcFooter" v-if="showAnswer">
                    <div>
                        <div :span="22/24">
                            <div class="qcfItem">
                                <span>正确答案：</span>
                                <span class="qcfiAnswer">{{ questionData.answer | answerCode }}</span>
                            </div>
                            <!-- 学生答案 -->
                            <template v-if="questionData.studentAnswer !== undefined">
                                <div class="qcfItem">
                                    ...
                                    <span class="qcfiAnswer" v-if="questionData.studentAnswer !== null">{{
                                      questionData.studentAnswer | answerCode }}</span>
