        ...
        <div class="recentPractice_next_question" style="min-height: 6.25rem">
            ...
            <div style="padding: 0 0.15rem">
                <div class="question_header">
                    ...
                    <h3 class="question_header_num" style="">第{{questionsSeq}}题 <span class="question_header_have" style="">还有<span class="question_header_queNum" style="">{{questionConf.count-questionsSeq}}</span>题 </span></h3>
            ...
            <scroller :scrollbar-x=false :scrollbarY=true @on-scroll="getNext" :height="top" style="overflow: auto">
                ...
                <question-show :show-data="questionData" v-else-if="(type==='homework'||type=='test')&&$route.query.questionsSeq"
                               :showInput="false"
                               :showAnswer="true"
                               @answer="setAnswer"></question-show>
...
//    },
      ...
      // 停止做测评
      stopDoTest () {
        console.log(this.questionAnswerArr.length === this.questionConf.count)
        this.stopDo(() => {
